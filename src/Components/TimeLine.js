...
function TimeLine() {
    return (
        <section className="mt-20">
            <div className="bg-primary flex w-full h-3 items-center gap-60">
                <div className="bg-primary w-8 h-8 rounded-full flex items-center ml-2">
            ...
            <div className="flex w-full items-center gap-12 mt-1 h-40 font-bold text-1xl">
                <section className="w-56 ml-4">
